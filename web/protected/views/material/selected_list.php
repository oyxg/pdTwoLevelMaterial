...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="github_tb">
	<thead>
		<tr class="row">
			...
			<th width="100" align="center">移库数量</th>
	...
	<tbody>
		...
		?>
		<tr>
			<td align="center"><?php echo Store::getName($rtm->material->storeID); ?></td>
			...
			<td align="left"><button class="grid_button" onclick="Material.removeToMoveForm(<?php echo $rtm->material->materialID;?>,reloadSelf);">删除</button></td>
		</tr>
		<?php endforeach;?>
	</tbody>
</table>
