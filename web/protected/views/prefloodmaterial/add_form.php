            ...
            <td>
                <table align="center" class="github_tb">
                    ...
                    <tr class="row">
                        ...
                        <td><input name="configure" id="configure" type="text" class="grid_text" value="<?= $data['goodsCode']?>"></td>
                    </tr>
                    <tr class="row">
                    ...
                    <tr class="row">
                        <td width="100" align="right">一班现存：</td>
                        <td><input name="a_xc" id="a_xc" type="text" class="grid_text"  value="<?= $data['a_xc']?>" /></td>
                    </tr>
                    <tr class="row">
                        <td width="100" align="right">二班现存：</td>
                        <td><input name="b_xc" id="b_xc" type="text" class="grid_text"  value="<?= $data['b_xc']?>" /></td>
                    </tr>
                    <tr class="row">
                        <td width="100" align="right">三班现存：</td>
                        <td><input name="c_xc" id="c_xc" type="text" class="grid_text"  value="<?= $data['c_xc']?>" /></td>
                    </tr>
                    <tr class="row">
                        <td width="100" align="right">四班现存：</td>
                        <td><input name="d_xc" id="d_xc" type="text" class="grid_text"  value="<?= $data['d_xc']?>" /></td>
                    </tr>
                    <tr class="row">
                        <td width="100" align="right">五班现存：</td>
                        <td><input name="e_xc" id="e_xc" type="text" class="grid_text"  value="<?= $data['e_xc']?>" /></td>
                    </tr>
                    <tr class="row">
                        <td width="100" align="right">六班现存：</td>
                        <td><input name="f_xc" id="f_xc" type="text" class="grid_text"  value="<?= $data['f_xc']?>" /></td>
                    </tr>
                    </tbody>
                </table>
            </td><!-- 右侧 -->
