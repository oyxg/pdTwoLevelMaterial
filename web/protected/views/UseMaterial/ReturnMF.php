<iframe  frameborder="0" src="/usematerial/selectlist2.html" width="100%" scrolling="no" onload="this.style.height=frames['materialFrm'].document.body.offsetHeight+'px';" name="materialFrm"></iframe>
<div class="tag" style="margin-top:10px;"> 退料单中的物资 </div>
<iframe  frameborder="0" src="/usematerial/selectedlist2.html" width="100%" scrolling="no" onload="this.style.height=frames['materialFrm2'].document.body.offsetHeight+'px';" name="materialFrm2"></iframe>
<div class="tag" style="margin-top:10px;"> 退料单的基本信息 </div>
<script>
	$(function(){
...
<form method="post" id="form" class="" name="form">
	<table border="0" cellspacing="0" cellpadding="0">
		...
		<tr style="height: 50px;">
			<td width="60" align="right"><strong>退料性质：</strong></td>
		...
		<tr style="height: 30px;">
			...
			<td width="100"><input name="glPro" id="glPro" type="text" class="grid_text"  value="<?= $inForm->glPro?>" /></td>
			<td align="right"><strong>项目编号：</strong></td>
			<td width="100"><input name="glProCode" id="glProCode" type="text" class="grid_text"  value="<?= $inForm->glProCode?>" /></td>
		</tr>
