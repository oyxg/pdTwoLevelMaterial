		...
		<tbody>
			<tr>
				...
				<td align="right"style="width: 520px;">
					<form method="get" action="<?=Yii::app()->createUrl("UseMaterial/SelectList")?>">
						批次号：
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="github_tb">
	...
	<tbody>
		...
		<tr>
			...
			<td align="left"><button class="grid_button" onclick="UseMaterial.addToReceiveForm(<?php echo $material['materialID'];?>,reloadSelectIframe);">添加到领用单</button></td>
		</tr>
		<?php endforeach;?>
	</tbody>
</table>
