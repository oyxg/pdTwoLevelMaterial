...
<!--			<th width="100" align="center">库存数量</th>-->
			<th width="100" align="center">实退数量</th>
<!--			<th width="100" align="center">总额</th>-->
	...
	<tbody>
		...
		<tr>
			...
			<td align="left"><?php echo $rtm->formCode; ?></td>
...
<!--			<td align="center">--><?php //echo $rtm->material->currCount; ?><!--</td>-->
			<td align="center"><?php echo floatval($rtm->number); ?></td>
<!--			<td align="center">--><?php //echo $rtm->number*$rtm->material->price; ?><!--</td>-->
			<td align="left"><button class="grid_button" onclick="UseMaterial.RemoveToReturnForm(<?php echo $rtm->material->materialID;?>,<?php echo $rtm->formCode;?>,reloadSelf);">删除</button></td>
		</tr>
		<?php endforeach;?>
	</tbody>
</table>
