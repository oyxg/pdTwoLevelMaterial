...
INSERT INTO `auth_item` VALUES ('Instrument', '1', '仪器仪表管理', '', 's:0:\"\";');
INSERT INTO `auth_item` VALUES ('InstrumentIn', '0', '仪器仪表台账', '', 's:0:\"\";');
INSERT INTO `auth_item` VALUES ('InstrumentInfo', '0', '仪器仪表配置', '', 's:0:\"\";');
INSERT INTO `auth_item` VALUES ('InstrumentList', '0', '仪器仪表汇总', '', 's:0:\"\";');
...
INSERT INTO `auth_item` VALUES ('PreFloodMaterialIn', '0', '防汛物资台账', '', 's:0:\"\";');
INSERT INTO `auth_item` VALUES ('PreFloodMaterialInfo', '0', '防汛物资配置', '', 's:0:\"\";');
INSERT INTO `auth_item` VALUES ('PreFloodMaterialList', '0', '防汛物资汇总', '', 's:0:\"\";');
...
INSERT INTO `auth_item_child` VALUES ('Materialer', 'Instrument');
INSERT INTO `auth_item_child` VALUES ('Storer', 'Instrument');
INSERT INTO `auth_item_child` VALUES ('Instrument', 'InstrumentIn');
INSERT INTO `auth_item_child` VALUES ('Instrument', 'InstrumentInfo');
INSERT INTO `auth_item_child` VALUES ('Instrument', 'InstrumentList');
...
-- ----------------------------
-- Table structure for `mod_instrument_class`
-- ----------------------------
DROP TABLE IF EXISTS `mod_instrument_class`;
CREATE TABLE `mod_instrument_class` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) NOT NULL COMMENT '仪器仪表分类名称',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mod_instrument_class
-- ----------------------------
INSERT INTO `mod_instrument_class` VALUES ('1', '水表');
INSERT INTO `mod_instrument_class` VALUES ('2', '电表');
INSERT INTO `mod_instrument_class` VALUES ('3', '电压表');
INSERT INTO `mod_instrument_class` VALUES ('4', '水压表');
INSERT INTO `mod_instrument_class` VALUES ('5', '煤气表');
INSERT INTO `mod_instrument_class` VALUES ('6', '阿斯蒂芬');
INSERT INTO `mod_instrument_class` VALUES ('7', '测试分类');

-- ----------------------------
-- Table structure for `mod_instrument_in`
-- ----------------------------
DROP TABLE IF EXISTS `mod_instrument_in`;
CREATE TABLE `mod_instrument_in` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `storeAddress` varchar(255) NOT NULL COMMENT '存放地址',
  `mID` int(11) NOT NULL COMMENT '物资ID，关联仪器仪表ID',
  `projectName` varchar(100) DEFAULT NULL COMMENT '项目名称',
  `projectCode` varchar(100) DEFAULT NULL COMMENT '项目编号',
  `materialCode` varchar(100) DEFAULT NULL COMMENT '仪器仪表物资编码',
  `equCode` varchar(100) DEFAULT NULL COMMENT '设备编号',
  `card` varchar(255) DEFAULT NULL COMMENT '资产卡片',
  `SAP` varchar(100) DEFAULT NULL COMMENT 'SAP编号',
  `num` int(11) NOT NULL DEFAULT '0' COMMENT '数量',
  `factory` varchar(255) DEFAULT NULL COMMENT '厂家',
  `factoryCode` varchar(100) DEFAULT NULL COMMENT '出厂编号',
  `factoryDate` date DEFAULT NULL COMMENT '出厂日期',
  `distribution` varchar(255) DEFAULT NULL COMMENT '配送单位',
  `contact` varchar(100) DEFAULT NULL COMMENT '联系人',
  `tel` varchar(100) DEFAULT NULL COMMENT '联系电话',
  `file` longtext COMMENT '附件',
  `state` enum('scrap','send','zc') NOT NULL DEFAULT 'zc' COMMENT '状态：scrap报废，send送修，normal正常',
  `date` date NOT NULL COMMENT '入库日期',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mod_instrument_in
-- ----------------------------
INSERT INTO `mod_instrument_in` VALUES ('1', '6', '1', '测试常用', '77777', '20161013', '10101010', '88888', '99999', '10', 'toyo', 'jjjjjjasdfa00000', '2016-10-13', 'young', 'cty', '123123123', ',upload/instrument_file/1_1.jpg,upload/instrument_file/1_2.xlsx', 'scrap', '2016-10-24');
INSERT INTO `mod_instrument_in` VALUES ('5', '4', '1', '123', '123', '123', '123', '24141', '123', '11', '23v', 'q\'we', '2016-10-01', '123', '3123', '12312', ',upload/instrument_file/5_1.jpg,upload/instrument_file/5_2.jpg', 'zc', '2016-10-24');
INSERT INTO `mod_instrument_in` VALUES ('6', '3', '1', '', '', 'asdfadsf', '', '', '', '0', '', '', '0000-00-00', '', '', '', null, 'zc', '2016-10-24');
INSERT INTO `mod_instrument_in` VALUES ('7', '5', '1', '', '', '123123123', '', '', '', '12', '', '', '0000-00-00', '', '', '', null, 'zc', '2016-10-24');
INSERT INTO `mod_instrument_in` VALUES ('8', '0', '1', '', '', null, '', '', '', '12', '', '', '0000-00-00', '', '', '', null, 'zc', '2016-10-25');
INSERT INTO `mod_instrument_in` VALUES ('9', '2', '1', '1111', '1111', null, '11111', '11111', '11111', '11', '1111', '1111', '2016-10-26', '111', '111', '111', null, 'zc', '2016-10-25');
INSERT INTO `mod_instrument_in` VALUES ('10', '1', '1', '2222', '1111', '3333', '666', '444', '555', '11', '777', '888', '2016-10-07', '99999', '00000', '121212', null, 'zc', '2016-10-25');
INSERT INTO `mod_instrument_in` VALUES ('11', '1', '3', '2222', '1111', '3333', '666', '444', '555', '11', '777', '888', '2016-10-06', 'asdf', '32vvv', '3333213', null, 'send', '2016-10-25');
INSERT INTO `mod_instrument_in` VALUES ('12', '0', '3', '2223', '22223', '222223', '121234', '1231234', '1231231234', '11', 'asdfasf4', '121212124', '2016-10-06', 'dfdfdf4', 'dffevev4', '1212124', ',upload/instrument_file/12_1.png', 'zc', '2016-10-25');
INSERT INTO `mod_instrument_in` VALUES ('13', '1', '2', '2222', '1111', '3333', '12123', '444', '55', '15', '12', '12121212', '2016-10-04', '333123', '123', '123', null, 'zc', '2016-10-26');
INSERT INTO `mod_instrument_in` VALUES ('14', '1', '2', '123', '312', '123', '123', '1231234123', '123', '3', '123', '333', '2016-10-11', '123', '1231', '23', '', 'send', '2016-10-26');
INSERT INTO `mod_instrument_in` VALUES ('15', '3', '4', '123123123', '123', '123', '123', '123123', '123', '22', '123', '123', '2016-10-05', '123', '123', '123', null, 'zc', '2016-10-26');
INSERT INTO `mod_instrument_in` VALUES ('16', '2', '4', '123', '123', '123', '23', '123', '123', '5', '1231', '123', '2016-10-13', '123', '123', '123', null, 'zc', '2016-10-26');
INSERT INTO `mod_instrument_in` VALUES ('17', '2', '4', '123', '123', '132', '213', '321', '123', '3', '12231', '123', '2016-10-05', '123', '123', '123', null, 'zc', '2016-10-26');
INSERT INTO `mod_instrument_in` VALUES ('18', '0', '2', '1212', '1212', '123', '123', '123', '123', '10', '123', '123', '2016-10-05', '123', '123', '123', null, 'zc', '2016-10-26');
INSERT INTO `mod_instrument_in` VALUES ('19', '2', '2', '1234', '1234', '1234', '1234', '1234', '1234', '10', '1234', '1234', '2016-10-06', '143', '1234', '1234', null, 'zc', '2016-10-26');
INSERT INTO `mod_instrument_in` VALUES ('20', '0', '2', '', '', '', '', '', '', '10', '', '', '0000-00-00', '', '', '', null, 'zc', '2016-10-27');
INSERT INTO `mod_instrument_in` VALUES ('21', '5', '4', '', '', '', '', '', '', '2', '', '', '0000-00-00', '', '', '', null, 'zc', '2016-10-27');
INSERT INTO `mod_instrument_in` VALUES ('22', '6', '1', '', '', '', '', '', '', '3', '', '', '0000-00-00', '', '', '', null, 'zc', '2016-10-27');
INSERT INTO `mod_instrument_in` VALUES ('23', '0', '1', '', '', '', '', '', '', '12', '', '', '0000-00-00', '', '', '', null, 'zc', '2016-11-23');
INSERT INTO `mod_instrument_in` VALUES ('24', '0', '1', '', '', '', '', '', '', '11', '', '', '2016-11-23', '', '', '', null, 'zc', '2016-11-23');

-- ----------------------------
-- Table structure for `mod_instrument_info`
-- ----------------------------
DROP TABLE IF EXISTS `mod_instrument_info`;
CREATE TABLE `mod_instrument_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `className` varchar(255) NOT NULL COMMENT '资产分类ID,关联仪器仪表分类ID',
  `name` varchar(255) NOT NULL COMMENT '物资名称',
  `num` int(11) NOT NULL COMMENT '配置数量',
  `price` double(11,2) NOT NULL COMMENT '单价',
  `unit` varchar(50) DEFAULT NULL COMMENT '配置单位',
  `standard` varchar(50) DEFAULT NULL COMMENT '规格型号',
  `jsgf` varchar(255) DEFAULT NULL COMMENT '技术规范',
  `isBp` enum('n','y') NOT NULL DEFAULT 'y' COMMENT '是否标配',
  `isZc` enum('n','y') NOT NULL DEFAULT 'y' COMMENT '是否资产',
  `mbh` varchar(100) DEFAULT NULL COMMENT '物资编号',
  `cbh` varchar(100) DEFAULT NULL COMMENT '公司编号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of mod_instrument_info
-- ----------------------------
INSERT INTO `mod_instrument_info` VALUES ('1', '电表', '电表11', '11', '24.99', '台', '阿福87', '急急急', 'y', 'n', '123123', '2d3e213e');
INSERT INTO `mod_instrument_info` VALUES ('2', '水表', '水表2', '10', '21.99', 'huhu', 'huhu', 'asdfadf', 'y', 'y', '12312', '312');
INSERT INTO `mod_instrument_info` VALUES ('3', '水压表', '水压表', '22', '12.80', '步步', '李莉莉', '范围呢哦', 'y', 'n', '31', '2e1ew');
INSERT INTO `mod_instrument_info` VALUES ('4', '水表', '水表3', '22', '43.99', '个', 'ssss', 'sdfasdfasdf', 'y', 'y', '12', 'w12w');
INSERT INTO `mod_instrument_info` VALUES ('5', '电表', '电表12', '12', '22.90', '台', 'inini', 'lalsdfasdf', 'y', 'n', '12w', '12w');
INSERT INTO `mod_instrument_info` VALUES ('6', '水表', '123', '12', '21.00', '个', '都13都', '爱妃吻啊qf', 'y', 'y', '12312s2333', '12w12w1333');
...
-- ----------------------------
INSERT INTO `mod_material` VALUES ('1', '9', '8890', 'wz10001', '3366', '物资1', '9001', '898989', '989898', 'toyo', '惠芬', '153456789123', '19*16*10', '个', '70.00', '2018-06-27', '啦啦啦啦', null, '10.000', '10.257', '10.000', '0');
...
INSERT INTO `mod_material` VALUES ('25', '9', 'WZ1606RK00014', '11111', '', '111', '', '', '', '', '', '', '', '', null, null, '', null, null, '45.000', '0.000', '0');
...
INSERT INTO `mod_move_form` VALUES ('36', '11', '20160628004', '', '2016-06-28', '', '0', null, null, ',upload/move_from_pic/36_1.jpg,upload/move_from_pic/36_3.jpg,upload/move_from_pic/36_8.jpg,upload/move_from_pic/36_9.jpg,upload/move_from_pic/36_10.xls');

-- ----------------------------
-- Table structure for `mod_preflood_class`
-- ----------------------------
DROP TABLE IF EXISTS `mod_preflood_class`;
CREATE TABLE `mod_preflood_class` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of mod_preflood_class
-- ----------------------------
INSERT INTO `mod_preflood_class` VALUES ('1', '挡水物资');
INSERT INTO `mod_preflood_class` VALUES ('2', '个人防护用品');
INSERT INTO `mod_preflood_class` VALUES ('3', '照明工具');
INSERT INTO `mod_preflood_class` VALUES ('4', '辅助配套物资');
INSERT INTO `mod_preflood_class` VALUES ('5', '排水物资');
INSERT INTO `mod_preflood_class` VALUES ('7', 'fff');
...
CREATE TABLE `mod_preflood_in` (
  ...
  `erpLL` varchar(50) DEFAULT NULL COMMENT 'ERP领料单',
  `file` longtext COMMENT '附件',
  `state` enum('scrap','send','zc') NOT NULL DEFAULT 'zc' COMMENT '状态：scrap报废，send送修，zc正常',
  `date` date NOT NULL,
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `mod_preflood_in` VALUES ('1', '1', '1', '10', '20160921001', '抢修沿塘变', '0001', '1515', ',upload/preflood_file/1_1.jpg,upload/preflood_file/1_2.pdf', 'zc', '2016-09-27');
INSERT INTO `mod_preflood_in` VALUES ('2', '1', '2', '5', '20160921002', '抢修沿塘变', '0002', '1515', null, 'zc', '2016-09-27');
INSERT INTO `mod_preflood_in` VALUES ('3', '1', '1', '8', '20160921002', '抢修锡山变', '0003', '1615', null, 'zc', '2016-09-27');
INSERT INTO `mod_preflood_in` VALUES ('4', '1', '3', '2', '20160921003', '抢修濒湖变', '0009', '2015', null, 'zc', '2016-09-27');
INSERT INTO `mod_preflood_in` VALUES ('5', '3', '1', '10', '160928001', '防汛抢修11', '92012', 'll49123', null, 'scrap', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('6', '4', '3', '15', '160928002', '防汛抢修工区', '09991', 'll1819', ',upload/preflood_file/6_1.xls,upload/preflood_file/6_2.jpg', 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('7', '1', '0', '24', '160928003', 'kaskdfj', '89001', '09119', ',upload/preflood_file/7_2.jpg,upload/preflood_file/7_3.xls,upload/preflood_file/7_4.docx', 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('8', '5', '1', '10', '', '', '', '', ',upload/preflood_file/8_2.xls,upload/preflood_file/8_3.png', 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('9', '6', '0', '100', '100', '100', '100', '100', ',upload/preflood_file/9_1.docx', 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('10', '7', '1', '9', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('11', '7', '2', '100', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('12', '7', '3', '333', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('13', '7', '5', '10', '12121', 'asdfasdf ', '1515', '38541', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('14', '1', '6', '100', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('15', '8', '6', '100', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('16', '1', '5', '50', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('17', '2', '5', '50', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('18', '6', '5', '50', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('19', '7', '5', '50', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('20', '8', '5', '50', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('21', '8', '1', '100', '', '', '', '', null, 'zc', '2016-09-28');
INSERT INTO `mod_preflood_in` VALUES ('22', '1', '0', '20', '按时ergaqa', 'sdfasdf', 'asdfa', 'sdf', ',upload/preflood_file/22_1.xlsx,upload/preflood_file/22_2.jpg', 'send', '2016-10-19');
INSERT INTO `mod_preflood_in` VALUES ('23', '5', '1', '5', '123', '123', '123', '123', ',upload/preflood_file/23_1.jpg', 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('24', '6', '3', '12', '123', '123', '123123', '123', null, 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('25', '5', '6', '21', '123', '123123', '123123', '123', null, 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('26', '2', '1', '22', '1223', '123123123W2', '12312', '12323', null, 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('27', '10', '4', '33', '12312', '3123', '123123', '123123', null, 'send', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('28', '9', '3', '5', '213412', '1234', '1234', '1234', null, 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('29', '3', '4', '23', 'Q2343', '23412', '3123', '123123', null, 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('30', '6', '5', '2', '123123', '1231231', '23', '123123', null, 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('31', '5', '2', '21', '1212', '12312312', '12312', '12', null, 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('32', '1', '0', '22', '1212123', '1231231123', '123123123', '123123', null, 'zc', '2016-10-21');
INSERT INTO `mod_preflood_in` VALUES ('33', '3', '0', '2', '123', 'ASDF', 'asdf2', '212', null, 'send', '2016-10-21');
...
CREATE TABLE `mod_preflood_info` (
  ...
  `configure` int(10) DEFAULT NULL COMMENT '配置标准',
  `factory` varchar(255) DEFAULT NULL COMMENT '厂家',
  ...
  `mbh` varchar(100) DEFAULT NULL COMMENT '物资编号',
  `cbh` varchar(100) DEFAULT NULL COMMENT '公司编号',
  `card` varchar(100) DEFAULT '' COMMENT '资产卡号',
  PRIMARY KEY (`id`)
...
-- ----------------------------
INSERT INTO `mod_preflood_info` VALUES ('1', '挡水物资', '雨靴1', '20.01', '双', '1111', '1111', '工区1', '9', '深圳市海洋王照明工程有限公司', '1102011111', '王1', '111111111', '输变配通用', '23q4rqfw', 'afwfe4c', '');
INSERT INTO `mod_preflood_info` VALUES ('2', '个人防护用品', '绝缘手套', '20.00', '黄色', null, '厚度0.2', '工区', '8', null, null, null, null, '输变配通用', 'asdfasdc', 'adfaf234', '');
INSERT INTO `mod_preflood_info` VALUES ('3', '个人防护用品', '绝缘靴', '20.09', '红色', null, 'bbbbb', '班组', '10', null, null, null, null, 'hsdfasdf', 'ad34r234', '2342', '');
INSERT INTO `mod_preflood_info` VALUES ('4', '个人防护用品', '电工钳', '34.89', '把', '1k', 'asdfasdf', '班组', '10', '北京电力设备', '9002-9090', '蔡瑁', '12340192384', 'asdfasdfH', '34234', '234', '');
INSERT INTO `mod_preflood_info` VALUES ('5', '个人防护用品', '盾', '10.00', '枚', '110', '110', '', '5', '', '', '', '', '', '234', '234', '');
INSERT INTO `mod_preflood_info` VALUES ('6', '照明工具', '手电筒', '15.00', '只', 'aaa', '', '工区', '10', '火葬场', '1', '王', '13333331234', '哈', '234', 'af4df32r', '');
INSERT INTO `mod_preflood_info` VALUES ('7', '辅助配套物资', '辅助', '33.33', '台', '', '', '', '5', '', '', '', '', '', '34f', '43f3', '');
INSERT INTO `mod_preflood_info` VALUES ('8', '排水物资', '排水', '10.00', '个', '', '', '', '12', '', '', '', '', '', '4f34f', '34f3', '');
INSERT INTO `mod_preflood_info` VALUES ('9', '挡水', 'buubua', null, '', '', '', '', null, '', '', '', '', '', '4f43f4f', 'tfqf4f', '');
INSERT INTO `mod_preflood_info` VALUES ('10', '12e1asdf', 'asdfasdf', '11.00', '个', 'asdf', 'fw23asdfa', 'fawe', '0', 'f232', '12afdf3111', 'aaaaa', '123123123', 'afsdf23', 'qa43f3', 'fq34', '');
INSERT INTO `mod_preflood_info` VALUES ('11', '挡水', '啦啦啦', '12.00', '个', 'w2ed', 'afweca', '工区', '12', '23423', '34234', '22342', '242', '4r3f4', '4r3', 'q34f3', '');
INSERT INTO `mod_preflood_info` VALUES ('12', '挡水物资', '1awce', '12.00', 'asdf', 'asdf', 'afweca', 'a', '12', 'asdfasfa', 'a', 'aaaaaa', 'a', 'afsdf23a', 'a', 'a', '');
INSERT INTO `mod_preflood_info` VALUES ('13', 'fff', '123', '11.00', '', '', '', '', null, '', '', '', '', '', '', '', '');
INSERT INTO `mod_preflood_info` VALUES ('14', '个人防护用品', '嘎帅的发呆', '123.00', '个', '阿城为此', '123', '阿萨德vfaweaec', '11', '123', '123', '123123', '12312', '3123', '12312s2333', '123', '123123');
...
-- ----------------------------
INSERT INTO `mod_receive_form` VALUES ('1', '9', '12', '20160613001', 'qx', null, '59595', '2151151', '135321', '', null, 'tg', null, '2016-06-13', null);
INSERT INTO `mod_receive_form` VALUES ('2', '9', '12', '20160613002', 'qx', null, '654581', '1212126851', '135322', '', null, 'tg', null, '2016-06-13', null);
...
INSERT INTO `mod_receive_form` VALUES ('31', '9', '12', '20160906003', 'dx', '2016-09-06', '', '12121212', '135323', '', ',upload/receive_pic/31_1.jpg,upload/receive_pic/31_2.jpg,upload/receive_pic/31_3.jpg,upload/receive_pic/31_4.xls', 'sh', null, '2016-09-06', 'bz1');
INSERT INTO `mod_receive_form` VALUES ('32', '9', '12', '20161123001', 'qx', '2016-11-23', '00014', '00014', null, '', null, 'sh', null, '2016-11-23', 'bz1');
...
INSERT INTO `mod_receive_form_material` VALUES ('44', '32', '25', 'WZ1606RK00014', '11111', '111', '', '', '4.000', '4.000', '4.000', '', null, null);
...
INSERT INTO `mod_return_form` VALUES ('2', '9', '12', '20160614001', 'dx', null, 'asdkjfa', '1531513', 'TL160600002', 'asdfs', null, 'tg', 'asdfasdf', '2016-06-14');
INSERT INTO `mod_return_form` VALUES ('3', '9', '13', '20160614002', 'qx', '17:49:00', 'asdfasd', '5138516', 'TL160600003', 'afwesdf', null, 'tg', '151515', '2016-06-14');
...
-- Records of mod_user
-- ----------------------------
INSERT INTO `mod_user` VALUES ('1', 'admin', '123', '超级管理员', '', '1', '185', '2016-10-27 17:43:35', '', '');
INSERT INTO `mod_user` VALUES ('4', 'gqcl', '123', '工区材料管理员', '', '', '280', '2016-11-30 14:00:10', '', '');
INSERT INTO `mod_user` VALUES ('5', 'cs1', '123', '测试网点1仓管', '', '', '16', '2016-09-22 19:10:41', '', '');
INSERT INTO `mod_user` VALUES ('6', 'cs2', '123', '测试网点2仓管', '', '', '3', '2016-10-27 18:00:38', '', '');
...
INSERT INTO `mod_user` VALUES ('12', 'bz1', '123', 'bz1', '', '', '142', '2016-11-23 15:55:45', '', '');
...
INSERT INTO `mod_user` VALUES ('29', 's1', '123', 's1', '', '', '2', '2016-10-27 17:43:50', '', '');
...
INSERT INTO `mod_user` VALUES ('33', 'v423', '123', 'v423', '', '', '1', '2016-10-12 17:46:41', '', '');
...
INSERT INTO `mod_user_store` VALUES ('15', '30', '9,10');
INSERT INTO `mod_user_store` VALUES ('16', '31', '10');
INSERT INTO `mod_user_store` VALUES ('17', '32', '10,11');
INSERT INTO `mod_user_store` VALUES ('18', '33', '10,11');
INSERT INTO `mod_user_store` VALUES ('19', '39', '9,10,11');

-- ----------------------------
-- View structure for `view_instrument_in`
-- ----------------------------
DROP VIEW IF EXISTS `view_instrument_in`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_instrument_in` AS select `in`.`id` AS `inID`,`in`.`storeAddress` AS `storeAddress`,`in`.`projectName` AS `projectName`,`in`.`projectCode` AS `projectCode`,`in`.`materialCode` AS `materialCode`,`in`.`equCode` AS `equCode`,`in`.`card` AS `card`,`in`.`SAP` AS `SAP`,`in`.`factory` AS `factory`,`in`.`factoryCode` AS `factoryCode`,`in`.`factoryDate` AS `factoryDate`,`in`.`distribution` AS `distribution`,`in`.`contact` AS `contact`,`in`.`tel` AS `tel`,`in`.`state` AS `state`,`in`.`date` AS `date`,`in`.`num` AS `num`,`info`.`className` AS `className`,`info`.`name` AS `name`,`in`.`mID` AS `mID` from (`mod_instrument_in` `in` left join `mod_instrument_info` `info` on((`info`.`id` = `in`.`mID`))) ;

-- ----------------------------
-- View structure for `view_instrument_list`
-- ----------------------------
DROP VIEW IF EXISTS `view_instrument_list`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_instrument_list` AS select `info`.`className` AS `class`,`info`.`name` AS `name`,`in`.`storeAddress` AS `address`,sum(`in`.`num`) AS `num`,`info`.`id` AS `mID` from (`mod_instrument_in` `in` left join `mod_instrument_info` `info` on((`in`.`mID` = `info`.`id`))) group by `info`.`className`,`info`.`name`,`in`.`storeAddress` order by `address` desc ;

-- ----------------------------
-- View structure for `view_preflood_in`
-- ----------------------------
DROP VIEW IF EXISTS `view_preflood_in`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_preflood_in` AS select `info`.`className` AS `className`,`info`.`name` AS `name`,`info`.`price` AS `price`,`info`.`unit` AS `unit`,`info`.`factory` AS `factory`,`info`.`bh` AS `bh`,`info`.`contact` AS `contact`,`info`.`tel` AS `tel`,`in`.`num` AS `num`,`in`.`projectCode` AS `projectCode`,`in`.`projectName` AS `projectName`,`in`.`workCode` AS `workCode`,`in`.`erpLL` AS `erpLL`,`in`.`file` AS `file`,`in`.`state` AS `state`,`in`.`bzID` AS `bzID`,`in`.`id` AS `InID`,`in`.`mID` AS `mID`,`in`.`date` AS `date` from (`mod_preflood_info` `info` left join `mod_preflood_in` `in` on((`info`.`id` = `in`.`mID`))) ;

-- ----------------------------
-- View structure for `view_preflood_list`
-- ----------------------------
DROP VIEW IF EXISTS `view_preflood_list`;
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `view_preflood_list` AS select `in`.`mID` AS `mID`,`in`.`bzID` AS `bzID`,sum(`in`.`num`) AS `nowNum` from `mod_preflood_in` `in` group by `in`.`mID`,`in`.`bzID` order by `in`.`mID` desc,`in`.`bzID` desc ;
